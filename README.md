...
- [ ] Debug logging: Add detailed logging to track time it takes for badge to load and tracks successfuly injected badges without comprimising page load times 
