// Score pill + tooltip in a shadow root so grocer CSS can't stomp it.
...
const TCLBadge = {
  ...
  create(product) {
    ...
    wrapper.innerHTML = `
      ...
      <span class="tcl-callout"><svg class="tcl-callout__leaf" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 1l1.5 3.5 3.5.5-2 3 1 3.5-2.5-1L12 13l-1.5-2.5-2.5 1 1-3.5-2-3 3.5-.5z"/><path d="M12 13v10M8 20l4-3 4 3" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>Canada Score</span>
    `;
  ...
  createCompact(product) {
    ...
    sheet.replaceSync(this.BADGE_STYLES + `
      ...
      .tcl-callout { font-size: 8px; padding: 1px 5px 1px 3px; }
      .tcl-callout__leaf { width: 8px; height: 8px; }
    `);
    shadow.adoptedStyleSheets = [sheet];
