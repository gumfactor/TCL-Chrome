/**
 * Lightweight caching layer using chrome.storage.local.
 * Each entry is stored with a timestamp; stale entries are purged on read.
 */

// Bump when lookup semantics change so old empty/wrong caches are ignored
